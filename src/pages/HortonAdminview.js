...
// ];
 ...
 useEffect( ()=> {
    setLoading(true);
    const unsub = onSnapshot(collection(db, "HortonPlace",), (snapshot)=> {
            let list =[];
...
const productsCollectionRef = collection(db, "HortonPlace");

const handleDelete= async (id)=>{
  if (window.confirm("Are you sure you want to delete")){
    try{
      const a = doc(db, "HortonPlace", id);
      await deleteDoc(a);
...
export default HortonAdminview