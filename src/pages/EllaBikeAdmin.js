...
// ];
 ...
 useEffect( ()=> {
    setLoading(true);
    const unsub = onSnapshot(collection(db, "EllaBike",), (snapshot)=> {
            let list =[];
...
const productsCollectionRef = collection(db, "EllaBike");

const handleDelete= async (id)=>{
  if (window.confirm("Are you sure you want to delete")){
    try{
      const productDoc = doc(db, "EllaBike", id);
