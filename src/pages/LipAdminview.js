...
// ];
 ...
 useEffect( ()=> {
    setLoading(true);
    const unsub = onSnapshot(collection(db, "Lipton'sSeat",), (snapshot)=> {
            let list =[];
...
const productsCollectionRef = collection(db, "Lipton'sSeat");

const handleDelete= async (id)=>{
  if (window.confirm("Are you sure you want to delete")){
    try{
      const a = doc(db, "Lipton'sSeat", id);
      await deleteDoc(a);
