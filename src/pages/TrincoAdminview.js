...
// ];
 ...
 useEffect( ()=> {
    setLoading(true);
    const unsub = onSnapshot(collection(db, "Trincomalee",), (snapshot)=> {
            let list =[];
...
const productsCollectionRef = collection(db, "Trincomalee");

const handleDelete= async (id)=>{
  if (window.confirm("Are you sure you want to delete")){
    try{
      const a = doc(db, "Trincomalee", id);
      await deleteDoc(a);
...
export default TrincoAdminview