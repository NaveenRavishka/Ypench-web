...
// ];
 ...
 useEffect( ()=> {
    setLoading(true);
    const unsub = onSnapshot(collection(db, "Knuckles",), (snapshot)=> {
            let list =[];
...
const productsCollectionRef = collection(db, "Knuckles");

const handleDelete= async (id)=>{
  if (window.confirm("Are you sure you want to delete")){
    try{
      const a = doc(db, "Knuckles", id);
      await deleteDoc(a);
...
export default KnuckelsAdminview